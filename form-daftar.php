...
<center>
    <header class="mt-4">
    <h3 class=" fw-bold">FORMULIR PENDAFTARAN KARYAWAN BARU</h3>
    </header>
<a href="index.php" class="btn btn-dark">kembali <i class="bi bi-arrow-right"></i></a>
</center>
    ...
    <form action="proses-pendaftaran.php" method="POST" class="p-3">
        <fieldset>
            ...
            <center>
            <p>
                <input type="submit" class="btn btn-dark" value="Daftar" name="daftar" style="width: 50%;" />
            </p>
            </center>
        </fieldset>
    </form>
